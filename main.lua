...
local opponentControl = "ai"  -- "ai" or "manual"
local aiStrategy = AI.side_bias -- Используем новую стратегию!
...
function love.update(dt)
    if gameState == "play" then
        -- Player 1 controls: W/S (up/down), A/D (left/right)
        local vdir = 0
        local hdir = 0
        ...
        -- Collision with paddles (swept, frame of reference)
